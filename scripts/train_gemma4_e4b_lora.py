...
This adapter fine-tunes **{MODEL_ID}** using LoRA on acoustic boundary verification and speaker purity, distilled directly from **Google Gemini 3.8 Flash** (`thinkingLevel="LOW"`).
