...
def main() -> int:
    ...
    p.add_argument('--device', type=str, default='auto', help='Inference device ("auto", "cpu", "cuda", or "hip")')
    ...
    p.add_argument('--torch-dtype', type=str, default='bfloat16', choices=('bfloat16', 'float16', 'float32'), help='PyTorch weights dtype')
