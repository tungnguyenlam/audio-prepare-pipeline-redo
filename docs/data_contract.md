...
```json
{
  ...
  "audit_records": [
    {
      ...
      "transcript": "chào các bạn hôm nay chúng ta",
  ...
  "funnel_stats": {
    ...
    "avg_tail_preservation_ms": 135.4,
  ...
  "stage_log": [
    ...
    "[3.2s] Stage 1: Running primary backend 'sortformer' on device 'cuda:0'",
    "[5.8s] Stage 2: Running secondary backend 'diarizen' on device 'cuda:1' for consensus",
    "[6.1s] Consensus retained 22 turns (64.2s)",
    "[6.4s] Stage 3b: Locking syllables with whisper_timestamped on cpu (model=vinai/PhoWhisper-small, lang=vi)",
  ...
  "config": {
    ...
    "handoff_risk_distance_s": 0.8,
    "silence_tail_buffer_s": 0.15,
